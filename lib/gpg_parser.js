...
//	if(content.slice(start_hash, start_hash + 4) == "SHA1") this.hash_method = "SHA1";
	...
	this.log(content);
	content = content.replace(String.fromCharCode(10), String.fromCharCode(13,10));
	//better would be to replace /\n/gi
...
$gp.verifyAuthentication = function(publickey, signature) {
        ...
        if(signature.signature.signature_algo == "dsa") {
		  ...
		  GPGPackageParser.prototype.log("no suitable authentication method provided");
		  return false;
                }
	}
 }
